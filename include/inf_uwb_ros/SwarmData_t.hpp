...
#ifndef __SwarmData_t_hpp__
#define __SwarmData_t_hpp__
...
int SwarmData_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int SwarmData_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int SwarmData_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t SwarmData_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* SwarmData_t::getTypeName()
{
    return "SwarmData_t";
}

int SwarmData_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int SwarmData_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int SwarmData_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
